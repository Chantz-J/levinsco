...
export default function Header(props){
    ...
    return(
        ...
        <nav className="menuBar" style={{display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', height: '70px',}}>
          <div className="logo">
            {/* <a href="">logo</a> */}
          </div>
          <div className="menuCon" style={{display: 'flex', width:'100%', justifyContent: 'space-between'}}>
            
            <div className="leftMenu" style={{width: '100%'}}>
              <LeftMenu />
            </div>
            <div className="rightMenu" style={{width: '100%',}}>
                <RightMenu />
            </div>
            

            {/* <Button className="barsMenu" type="primary" onClick={() => showDrawer()} style={{ display: 'none'}}>
